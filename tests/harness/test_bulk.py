...
"""Harness tests for sp_drive_file_checkout_bulk / sp_drive_file_checkin_bulk (#41).

Each run seeds 5 throwaway test files via sp_drive_file_upload, exercises the
...
def test_open_many_runs_concurrently_under_real_latency(
    ...
    """Sequential 5x sp_drive_file_checkout against real Graph would take ~2s+ at typical
